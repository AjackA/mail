...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        class mailThread implements Runnable{
            ...
            public void run() {
                ...
                Toast toast;
                try {
                    Log.i("logcat",username_Thread);//输出日志info
                    ...
                    if(!line.contains("successful")){
                        ...
                        intent.putExtra("username",username_Thread);
                        intent.putExtra("password",password_Thread);
    ...
    public String Base64String(String s){
        s=Base64.encodeToString(s.getBytes(),Base64.DEFAULT);//base64编码
        return s;
    }
}
